...
export interface ItemProps{
    ...
    label?: ReactNode; // 标签
    name?: string; // 表单项的名称（用于后续收集提交的key）
    valuePropName?: string; // 表单项的值的属性名（value/checked）
    rules?: Array<Record<string, any>>; // 表单项的验证规则
    children?: ReactElement // 表单项的子元素（注意这里是ReactElement，而不是ReactNode，因为要求表单项子元素一定要是element节点）
}
